...
public class Add extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        department.setModel(new javax.swing.DefaultComboBoxModel(new String[] { " ", "Auditing", "Accounting", "IT" }));
                                ...
                                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addGroup(jPanel4Layout.createSequentialGroup()
                                        .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                            ...
                                            .addComponent(empid, javax.swing.GroupLayout.DEFAULT_SIZE, 145, Short.MAX_VALUE)
                                        ...
                                        .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                            .addComponent(salary)
                                            .addComponent(startdate, javax.swing.GroupLayout.DEFAULT_SIZE, 153, Short.MAX_VALUE))
        ...
        getContentPane().add(jPanel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 100, 540, 500));

        jLabel14.setFont(new java.awt.Font("Cambria", 0, 70)); // NOI18N
        jLabel14.setText("BECOME ONE OF US!");
        getContentPane().add(jLabel14, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 20, 650, 60));

        jLabel42.setIcon(new javax.swing.ImageIcon("C:\\Users\\Sony\\Desktop\\CCS\\Systems\\Backgrounds\\add.jpg")); // NOI18N
        getContentPane().add(jLabel42, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, -20, 980, 650));
    ...
    private void departmentActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_departmentActionPerformed
        ...
        if(department.getSelectedItem()=="IT"){
            job.addItem("Programmer");
            job.addItem("IT Support");
            job.addItem("Database Manager");
        } else {
            job.removeItem("Programmer");
            job.removeItem("IT Support");
            job.removeItem("Database Manager");
        }
        if(department.getSelectedItem()=="Accounting"){
            job.addItem("Accountant");
            job.addItem("Bookkeeper");
            job.addItem("Payroll Clerk");
        }  else {
            job.removeItem("Accountant");
            job.removeItem("Bookkeeper");
            job.removeItem("Payroll Clerk");
        }
        if(department.getSelectedItem()=="Auditing"){
            job.addItem("Auditor");
            job.addItem("Audit Consultant");
            job.addItem("Internal Auditor");
        } else {
           job.removeItem("Auditor");
           job.removeItem("Audit Consultant");
           job.removeItem("Internal Auditor");
        }
